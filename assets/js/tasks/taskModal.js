...
/**
 * Render a modal showing the task's details.
 * @typedef {Object} Task
 */
export function renderTaskModal(task) {
  ...
  modalWrapper.innerHTML = `
    <!-- Backdrop -->
      ...
      <!-- Form Container -->
      <div id="formContainer" class="bg-white dark:bg-dark-grey absolute top-[64px] lg:top-[249px] left-0 right-0 m-auto w-[343px] md:w-[600px] p-[24px] rounded-[6px] h-[600px] md:h-[560px] flex flex-col g-[24px]">
  ...
  modalWrapper.querySelector("#closeModalBtn").addEventListener("click", () => {
    modalWrapper.remove();
  });
}
